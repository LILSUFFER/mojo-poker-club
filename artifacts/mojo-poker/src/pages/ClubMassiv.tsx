    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1, padding: isMobile ? '40px 0 64px' : '72px 0 100px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: isMobile ? '0 20px' : '0 40px' }}>
          ...
          {/* ── Top: info card + VPN ── */}
          <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: 24, marginBottom: isMobile ? 36 : 56, alignItems: 'flex-start' }}>

            {/* ── LEFT: combined club info card ── */}
            <div style={{ flex: 1, borderRadius: 8, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)', background: 'var(--bg-card)' }}>

              {/* Club header: logo thumb + name */}
              <div style={{ display: 'flex', alignItems: 'center', gap: 0, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                <div style={{ background: '#fff', width: 100, flexShrink: 0, alignSelf: 'stretch', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 12px', position: 'relative' }}>
                  <img src="/images/mojo2-logo.png" alt="MOJO 2" style={{ width: '100%', height: 'auto', display: 'block', objectFit: 'contain' }} />
                  <img src="/images/union-badge-orig.png" alt="Union" style={{ position: 'absolute', top: 6, right: 6, width: 24, height: 24, objectFit: 'contain', display: 'block' }} />
                </div>
                <div style={{ padding: '18px 24px' }}>
                  ...
                  <p style={{ margin: '0 0 4px', fontSize: 18, fontWeight: 700, color: 'white', lineHeight: 1.2 }}>MOJO: Massiv Poker Union</p>
              ...
              {/* GEO notice + CTA */}
              <div style={{ padding: '16px 24px 20px', display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
                ...
                <Link href="/join" style={{
                  ...
                  padding: '12px 28px', borderRadius: 4, textDecoration: 'none', flexShrink: 0,
